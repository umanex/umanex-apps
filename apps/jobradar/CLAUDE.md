...
| **Leads** | Afgeleid uit de vacaturedata (`lib/signals.ts`, bron `vacatures`). De KBO-spiegel bestaat sinds 2026-08-29 (zie hieronder), maar `lib/sources/kbo.ts` hangt er nog niet aan — dat wacht op de scoringsas. |
