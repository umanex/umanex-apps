        ...
        <div className="flex items-center gap-1 shrink-0">
          <input
            ...
            className={`w-[92px] h-7 px-2 text-[13px] text-right tabular-nums rounded-[4px] border border-[var(--umanexNeutral300)] focus:outline-none focus:ring-1 focus:ring-ring ${
              isComputed
                ? `bg-[var(--umanexNeutral50)] cursor-default ${syncValue < 0 ? 'text-finance-negative font-medium' : 'text-finance-positive'}`
                : `bg-white text-finance-deferred ${pot.hasSettlement ? 'font-medium' : ''}`
            }`}
