 ...
 * as `hsl(var(--token))` and opacity modifiers like `bg-accent-default/50` keep working.
 *
 ...
 *
 * Deliberate copy of packages/tokens/lib/hslTriplet.mjs. The two token pipelines
 * (umanex role layer, RowTrack app DNA) are independent by design; importing across
 * them would create a dependency where none should exist, for a pure function of
 * fifty lines. Keep them in sync by hand if the rounding strategy ever changes.
 *
