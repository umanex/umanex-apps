...
- **Check:** `grep -n "movement: -netBurn" apps/cashflow/lib/cashflow/buffer.ts` — een treffer betekent dat de footer zijn beweging nog steeds buiten `subtotals` om moet halen, en dus dat de asymmetrie er nog is.
