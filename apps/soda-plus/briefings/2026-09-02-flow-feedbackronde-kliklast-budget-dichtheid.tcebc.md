...
- 2026-09-02 (later op de dag): **00 verplaatst van Sectie 2 naar Sectie 1**, naast 08 (x=535, y=2204), op vraag van Jeroen. Reden: nadat de probleemstelling losgekoppeld werd van het lege leerlingvak, is 00 het scherm dat het bewijs draagt — dezelfde twee werkpunten als op het papieren rapport (DW1/DW2 = B·B·A·A en B·B·A·B), maar met een afspraak, een datum en een gesprek eraan. Sectie 2 opnieuw uitgelijnd: 04b → x=80, 08b → x=535, 05c → x=990. De acceptatie-regel hierboven die 05c op x=1445 meet, beschrijft de staat van díe ronde, niet de huidige. Caption 00 kreeg een nieuwe titel en een tweede helft die de stagnatie benoemt.
- 2026-09-02 (later op de dag): **schermtelling op de cover van 13 naar 14.** 00 stond al in de keten op de cover (`… → 08 → 00`) maar werd niet meegeteld — een off-by-one die pas zichtbaar werd toen 00 formeel deel van de flow werd. Persona-telling: 01 + 02×4 + 03×2 + 04 + 05 + 05b + 06 + 07 + 08 + 00 = 14. De tikkentelling (±22 vóór de onthulling) verandert niet; 00 komt erna.
