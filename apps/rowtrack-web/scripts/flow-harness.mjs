 ...
 *
 *   pnpm --filter rowtrack-web flow             # volle run
 *   pnpm --filter rowtrack-web flow --selftest  # bewijst dat hij kán falen
 *   pnpm --filter rowtrack-web flow --headed    # meekijken terwijl het gebeurt
 *   pnpm --filter rowtrack-web flow --shot=.flow-shots  # render per route vastleggen
 *
